...
$(document).ready(function() {
    ...
    //$(".navbar-main").addClass("gradient-45deg-indigo-blue")
    //$(".content-wrapper-before").addClass("gradient-45deg-indigo-blue")
    //$(".sidenav-main .sidenav li a.active").addClass("gradient-45deg-indigo-blue");

    function r(e) {
        e ? ($(".menu-dark-checkbox").prop("checked", !0), 
                $("body").removeClass("sidenav-light").addClass("black"),
                $(".sidenav-main").removeClass("sidenav-light").addClass("sidenav-dark"),
                $(".theme-cutomizer").removeClass("sidenav-light").addClass("sidenav-dark"),
                //$(".rightside-navigation").removeClass("sidenav-light").addClass("sidenav-dark"),
                $(".card").removeClass("sidenav-light").addClass("sidenav-dark"),
                $(".chat-content-header").removeClass("black-text").addClass("white-text")
             ) : 
            ($(".menu-dark-checkbox").prop("checked", !1), 
                $("body").addClass("sidenav-light").removeClass("black"),
                $(".sidenav-main").addClass("sidenav-light").removeClass("sidenav-dark"),
                $(".theme-cutomizer").addClass("sidenav-light").removeClass("sidenav-dark"),
                //$(".rightside-navigation").addClass("sidenav-light").removeClass("sidenav-dark"),
                $(".card").addClass("sidenav-light").removeClass("sidenav-dark"),
                $(".chat-content-header").addClass("black-text").removeClass("white-text")
            )
    }
    ...
    $("body").hasClass("vertical-modern-menu") || $("body").hasClass("vertical-menu-nav-dark") ? $(".menu-bg-color").hide() : $("body").hasClass("vertical-gradient-menu") || $("body").hasClass("vertical-dark-menu") ? ($(".menu-color").hide(), menuBgDefault = !0) : $("body").hasClass("horizontal-menu") && $(".menu-options").hide(), $(".menu-color-option, .menu-bg-color-option").click(function(e) {
        ...
        a = n, d(".navbar-main"), $(".navbar-main").addClass(a), $("body").hasClass("vertical-modern-menu") && (d(".content-wrapper-before"), $(".content-wrapper-before").addClass(a))
        
        $.ajax({ url: "/update/theme/" + selectedTheme }).done(function (data) {});
        
    }), $(".menu-dark-checkbox").click(function(e) {
        var m = $(".menu-dark-checkbox").prop("checked")
        m ? r(!0) : r(!1)
        $.ajax({ url: "/update/mode/" + m }).done(function (data) {});
        ...
        $.ajax({ url: "/update/menu/" + a }).done(function (data) {});
        ...
        d(".chat-area"), $(".chat-area").addClass(a)
        $.ajax({ url: "/update/chatarea/" + a }).done(function (data) {});
